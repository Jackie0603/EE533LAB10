...
@EXPORT = qw(
                ...
                IN_ARB_STATE_REG
                PROCESSOR_LAB6_ADDR_REG
                PROCESSOR_CHECK_REG
                PROCESSOR_CHECK_HIGH_REG
                PROCESSOR_CHECK_LOW_REG
                OQ_QUEUE_0_CTRL_REG
...
sub PROCESSOR_BASE_ADDR ()       { 0x2000300; }
...
sub PROCESSOR_LAB6_ADDR_REG ()    { 0x2000300;}
sub PROCESSOR_CHECK_REG ()        { 0x2000304;}
sub PROCESSOR_CHECK_HIGH_REG ()   { 0x2000308;}
sub PROCESSOR_CHECK_LOW_REG ()    { 0x200030c;}
