...
def PROCESSOR_LAB6_ADDR_REG ():  
    return 0x2000300

def PROCESSOR_CHECK_REG ():      
    return 0x2000304

def PROCESSOR_CHECK_HIGH_REG (): 
    return 0x2000308

def PROCESSOR_CHECK_LOW_REG ():  
    return 0x200030c
...
__main__.nf_regmap.update({
    ...
    0x2000300 : "PROCESSOR_LAB6_ADDR_REG",
    0x2000304 : "PROCESSOR_CHECK_REG",
    0x2000308 : "PROCESSOR_CHECK_HIGH_REG",
    0x200030c : "PROCESSOR_CHECK_LOW_REG",
